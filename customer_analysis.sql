...
select sum(purchase_amount) as revenue, gender from customer_data 
group by gender
...
select item_purchased, round(avg(review_rating::numeric),2) as Average_Review_Rating from customer_data
